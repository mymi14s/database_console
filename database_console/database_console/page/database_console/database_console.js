...
MyPage = Class.extend({
	...
	make: function(){
		...
		$(frappe.render_template(frappe.database_console_page.body, this)).appendTo(this.page.main);
	  ...
	  document.head.appendChild(scrtag);
		...
		function makeQuery(formQuery){
			...
			frappe.call({
            method: "database_console.database_console.page.database_console.database_console.query_database", //dotted path to server method
                ...
                // code snippet
								...
								if(result.reply==0){
									...
									if(result.content.length>1){
										...
										frappe.msgprint('Done with empty set');
									}
								}
            }
        })
